            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        endTime = new Date();
                        console.log("update " + id + "@" + startTime.toISOString() + " with " + shipmentData + " finished@" + endTime.toISOString());
...
var ShipmentUpdateListener = /** @class */ (function (_super) {
    __extends(ShipmentUpdateListener, _super);
    function ShipmentUpdateListener() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ShipmentUpdateListener.prototype.receiveUpdate = function (id, shipmentData) {
        var _this = this;
        lock.acquire(id, function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.updateShipment(id, shipmentData)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
...
var shipment = new ShipmentUpdateListener();
